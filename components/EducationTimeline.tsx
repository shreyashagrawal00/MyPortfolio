...
export default function EducationTimeline() {
  return (
    <section className="py-24 px-6 md:px-12 bg-base-dark border-t border-neutral-carbon/30">
      <div className="max-w-4xl mx-auto">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="font-heading text-3xl md:text-4xl tracking-widest text-white mb-16 text-center"
        >
          EDUCATION <span className="text-accent-metal">HISTORY</span>
        </motion.h2>

        <div className="relative border-l border-neutral-carbon ml-4 md:ml-0">
          {educationData.map((item, index) => (
            ...
            >
              {/* Timeline dot */}
              <div className="absolute -left-[31px] top-1.5 w-4 h-4 rounded-full bg-accent-metal border-4 border-base-dark shadow-[0_0_10px_rgba(183,28,28,0.5)]" />

              <div className="bg-neutral-carbon/20 border border-neutral-carbon/50 p-6 md:p-8 backdrop-blur-sm hover:border-accent-metal/50 transition-colors duration-300">
